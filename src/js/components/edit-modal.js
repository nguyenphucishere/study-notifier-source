Vue.component('edit-modal', {
    ...
    methods: {
        reset(){
            this.start_time = this.subject_data.start_time
            this.end_time = this.subject_data.end_time
            this.subject = this.subject_data.subject
            this.teacher = this.subject_data.teacher
            this.password = this.subject_data.pwd
            this.roomId = this.subject_data.room_id
            this.meetLink = this.subject_data.meet_link
        },
        close(){
            (() => {
